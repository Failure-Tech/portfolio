...
// Define the base props without children initially
...
export function HoverBorderGradient({
  ...
  clockwise = true,
  ...props
}: React.PropsWithChildren<HoverBorderGradientBaseProps & React.HTMLAttributes<HTMLElement>>) {
  ...
  return (
    <Tag
      onMouseEnter={(event: React.MouseEvent<HTMLElement>) => { // Changed type to HTMLElement
        setHovered(true);
        // console.log(event); // Removed console.log as it might be noisy
      }}
      ...
      href={link} // Pass link directly as href (only applies if Tag is 'a')
      {...props}
    >
      <div
        className={cn(
